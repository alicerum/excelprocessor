...
get the app created:
    ...
    $ heroku apps:create excelprocessor
    Creating excelprocessor... done, stack is cedar
    http://excelprocessor.herokuapp.com/ | git@heroku.com:excelprocessor.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://excelprocessor.herokuapp.com deployed to Heroku

    To git@heroku.com:excelprocessor.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://excelprocessor.herokuapp.com
    ["Hello" :from Heroku]
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@excelprocessor.herokuapp.com/repl
